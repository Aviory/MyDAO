...
namespace DAO
{
    class MS_SQL_Person : iPersonDAO
    {
        ...
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\vel\MyDBOffset\DAO\MS_SQLData.mdf;Integrated Security=True");
        SqlCommand cmd;
        string qwery;
